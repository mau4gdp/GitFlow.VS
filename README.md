...
### Prerequirements
The extension requires Visual Studio 2026 (it's also available for VS2022, VS2019, VS2017 and VS2015). It will install GitFlow for you if it is not found on the machine. Since GitFlow depends on Git for Windows, this must be installed before using the extension 
